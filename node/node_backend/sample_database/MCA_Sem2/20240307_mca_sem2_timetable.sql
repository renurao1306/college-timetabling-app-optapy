...
INSERT INTO `CONSTRAINTS` VALUES (9,1,'fixed_slot_conflict',NULL,'A fixed slot course cannot be overridden by a non-fixed course','hard',100,NULL,1),(10,1,'teacher_room_stability',NULL,'A teacher would like to teach a course in the same room','soft',1,NULL,1),(11,5,'room_conflict',NULL,'A room can accommodate at most one course at the same time','hard',10,NULL,1);
...
INSERT INTO `FIXED_SLOTS` VALUES (1,2,50001,1,2,1),(5,4,50003,8,2,NULL);
...
INSERT INTO `GENERAL_RUN_PARAMS` VALUES (10,3,'max_hrs_in_day','Maximum hours that a student group can attend courses in a day',30),(11,3,'runtime_in_secs','Runtime limit in seconds for the planner ',100),(12,1,'runtime_in_secs','Runtime limit in seconds for the planner ',30),(13,1,'max_hrs_in_day','Maximum hours that a student group can attend courses in a day',10),(14,5,'runtime_in_secs','Runtime limit in seconds for the planner ',30),(16,6,'runtime_in_secs','Runtime limit in seconds for the planner ',30);
...
-- Dump completed on 2024-03-07  9:22:17
