...
import Logo from './assets/mpstmelogo.jpg';
...
function Copyright(props) {
  return (
    <Typography variant="body2" color="text.secondary" align="center" {...props}>
      {'Copyright © '}
      <Link color="inherit" href="https://www.linkedin.com/in/-renu-rao/" target="_blamk" rel="noreferrer">
        Renu Rao
      </Link>{' '}
